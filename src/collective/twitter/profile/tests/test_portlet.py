...
from collective.twitter.profile.testing import INTEGRATION_TESTING
...
from collective.twitter.profile.portlet import twsearch
...
class PortletTest(unittest.TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='collective.twitter.profile.TwitterProfilePortlet')
        self.assertEquals(portlet.addview,
                          'collective.twitter.profile.TwitterProfilePortlet')
